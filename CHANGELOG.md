...
- Add 3 deferred-finding entries (TD-083, TD-084, TD-085) to [`docs/TechnicalDebt.md`](docs/TechnicalDebt.md) covering the `OutcomeProcessor` dedup lock TOCTOU contract and the unbounded `_processed_outcome_ids` set growth surfaced during pre-PR review, plus the `submit_actions` validator-exception leak path raised in PR #57 review
