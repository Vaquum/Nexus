...
def _capture_structlog(func: Any) -> dict[str, Any]:
    ...
    Args:
        func: Callable that emits exactly one structlog log line.

    Returns:
        Parsed JSON log output.
    '''
...
def _capture_stdlib(func: Any) -> dict[str, Any]:
    ...
    Args:
        func: Callable that emits exactly one stdlib log line.
...
def test_bind_context_appears_in_logs() -> None:
    ...
    clear_context()
    bind_context(account_id='acc1', trade_id='t1')
